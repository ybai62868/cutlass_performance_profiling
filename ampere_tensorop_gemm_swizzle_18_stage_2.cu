...
struct Options {
  ...
  Options()
      : help(false), problem_size({4096, 4096, 4096}), batch_count(1),
...
using ShapeMMAOp =
    cutlass::gemm::GemmShape<16, 8, 16>; // <- MMA Op tile M = 16, N = 8, K = 

// This code section describes how threadblocks are scheduled on GPU
using SwizzleThreadBlock =
    cutlass::gemm::threadblock::GemmIdentityThreadblockSwizzle<18>; // <- ??
